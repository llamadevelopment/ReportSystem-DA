package net.llamadevelopment.reportsystemda.components.language;
...
public class Language {
    ...
    public static void init() {
        messages.clear();
        ReportSystemDA.getInstance().saveResource("messages.yml");
        Config m = new Config(ReportSystemDA.getInstance().getDataFolder() + "/messages.yml");
